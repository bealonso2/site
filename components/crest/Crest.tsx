export const Crest = () => (
  <svg
    ...
    height={192}
  >
    {/* Cross hairs for alignment and rule of thirds lines */}
    {/* <line x1="128" y1="0" x2="128" y2="256" stroke="black" />
      <line x1="0" y1="128" x2="256" y2="128" stroke="black" />
      <line x1="85.33" y1="0" x2="85.33" y2="256" stroke="black" />
      <line x1="170.67" y1="0" x2="170.67" y2="256" stroke="black" />
      <line x1="0" y1="85.33" x2="256" y2="85.33" stroke="black" />
      <line x1="0" y1="170.67" x2="256" y2="170.67" stroke="black" /> */}
    {/* Shield Shape */}
    <g transform="scale(1.25) translate(-25.7, -25)">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width={256}
        height={256}
    ...
    <g transform="translate(0, -10)">
      {/* Open Book */}
      <g transform="translate(133.5, 65)">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="74"
          height="74"
      ...
      <g transform="translate(56, 72)">
        ...
        >
          <path
            fill="none"
            stroke="currentColor"
            d="M7.5 15V7m0 .5v3m0-3a4 4 0 0 0-4-4h-3v3a4 4 0 0 0 4 4h3m0-3h3a4 4 0 0 0 4-4v-3h-3a4 4 0 0 0-4 4zm0 0l4-4m-4 7l-4-4"
          />
        </svg>
      </g>
    </g>
